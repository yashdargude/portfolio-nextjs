      ...
      <div className="flex flex-wrap items-center justify-center p-4 gap-16 mt-10">
        {projects.map((item) => (
          ...
          >
            ...
            >
              <div className="relative flex items-center justify-center sm:w-80 w-[70vw] overflow-hidden h-[20vh] lg:h-[25vh] mb-10">
                <div
              ...
              <div className="flex items-center justify-between mt-7 mb-3">
                ...
                <div className="flex justify-center items-center">
                  <a
                    ...
                    className="flex lg:text-l md:text-xs text-sm text-purple items-center"
                  >
                    Check Live Site
